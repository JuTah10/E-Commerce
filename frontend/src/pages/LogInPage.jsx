    ...
    return (
        <div className='min-h-[calc(100vh-5rem)] flex items-center justify-center bg-emerald-500'>
            <div className="bg-white rounded-lg p-8 flex w-11/12 max-w-4xl mx-auto">
                ...
                >
                    <img src="https://res.cloudinary.com/dc3gnvd4e/image/upload/v1748097470/hoodiesSignInPage_pod1u9.avif" alt="Sneakers" className="h-full object-cover rounded-2xl" />
                </motion.div>
